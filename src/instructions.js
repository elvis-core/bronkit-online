...
2. If the user hasn't yet set up the metronome, run the activation flow: call strategy_list (show what's enabled), then scheduler_setup_text, and hand the user its pasteText verbatim with two steps — open Cowork, type /schedule, paste this, confirm. That one hourly task drives ALL strategies. (If the metronome already exists, don't send them back to Cowork — the strategy is stored + enabled and will be evaluated next tick.)
